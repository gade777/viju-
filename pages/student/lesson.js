                    ...
                    <div className="card-title d-flex flex-row justify-content-between align-items-center w-100 mb-0 m-0">
                      <div className="d-flex flex-row align-items-center gap-4">
                        ...
                        <div className="d-flex flex-column">
                          <span className="fs-1 mb-1 fw-bolder"> {lessonsDetails[fbc.LESSON_NAME]}</span>

                          <span className="fs-6 text-muted">{utility.padwithzero(Object.keys(lessonsDetails[fbc.LESSON_CONTENT]).length)} Contents</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card-body p-2 d-flex flex-column " id="contentdiv">
                    ...
                    <div className="accordion accordion-icon-toggle" id="subjectlessonaccordian">
...

                      {
                        ...
                        <div id={"kt_accordion_body_" + lessonsDetails[fbc.LESSON_UID]}

                          className={"accordion-collapse collapse  " + (lessonUID !== null ? lessonUID === lessonsDetails[fbc.LESSON_UID] ? " show " : "" : "")}

                        >
                          <div className="accordion-body p-2">
                            <ul
                              id={"lessontabs_" + lessonsDetails[fbc.LESSON_UID]}
                            ...
                            >
                              <li className="nav-item g-5">
                                <button
                                  ...
                                  data-bs-toggle="tab"
                                  id={"content_tabbtn_" + lessonsDetails[fbc.LESSON_UID]}
                                  href={"#content_" + lessonsDetails[fbc.LESSON_UID]}
                                >
                                  Content
                                </button>
                              </li>
                                ...
                                subjectDetails[fbc.SUBJECT_HASASSESSMENTS] ? <>
                                  <li className="nav-item g-5">
                                    <button
                                      ...
                                      className="nav-link text-xs btn btn-outline btn-active-light-primary px-4 py-1 me-2"
                                      data-bs-toggle="tab"
                                      id={"assesment_tabbtn_" + lessonsDetails[fbc.LESSON_UID]}
                                      href={"#assesment_" + lessonsDetails[fbc.LESSON_UID]}
                                    >
                                      Assesment
                                    </button>
                                  </li>
                            ...
                            <div className="tab-content h-100" id={"lessontabContent_" + lessonsDetails[fbc.LESSON_UID]}
                            >

                              <div
                                className="tab-pane fade h-100"
                                id={"content_" + lessonsDetails[fbc.LESSON_UID]}
                                role="tabpanel"
                              >

                                {
                                  Object.keys(lessonsDetails[fbc.LESSON_CONTENT]).map((key, index) => {
                                    var content = lessonsDetails[fbc.LESSON_CONTENT][key];
                                    return (<a
                                      onClick={(e) => {
                              ...
                              <div
                                className="tab-pane fade h-100"
                                id={"assesment_" + lessonsDetails[fbc.LESSON_UID]}
                                role="tabpanel"
                              >
