    ...
    if (ticketIDsnapshot.empty) {
      ...
      if (hasValidData) {
        ...
        return (data = {
          ...
          data: '',
          message:
            'Teacher Email Address Already Exists, ' + teacherData['teacher_emailaddress'],
        });
      }
    }
    ...
    if (ticketIDsnapshot.empty) {
      ...
      if (hasValidData) {
        ...
        return (data = {
          ...
          data: '',
          message:
            'Board Code Already Exists, ' + boardData['board_code'],
        });
      }
    }
    ...
    if (ticketIDsnapshot.empty) {
      ...
      if (hasValidData) {
        ...
        return (data = {
          ...
          data: '',
          message:
            'Course Code Already Exists, ' + courseData['course_code'],
        });
      }
    }
    ...
    if (ticketIDsnapshot.empty) {
      ...
      if (hasValidData) {
        ...
        return (data = {
          ...
          data: '',
          message:
            'Lesson Code Already Exists, ' + lessonData['lesson_code'],
        });
      }
    }
    ...
    function updatelessonData() {
      ...
      if (isNewLesson) {
        ...
        batch.set(subjectdocref, {
          ...
          subject_lessonsuidarray: admin.firestore.FieldValue.arrayUnion(lessonData['lesson_uid']),
          subject_lessons: {
    ...
    if (ticketIDsnapshot.empty) {
      ...
      if (hasValidData) {
        ...
        return (data = {
          ...
          data: '',
          message:
            'Assessment Code Already Exists, ' + asmtData['asmt_code'],
        });
      }
    }
...
exports.submittedStudentAssessment = functions.firestore
  ...
  .onUpdate(async (change, context) => {
    ...
    if (newStatus === "COMPLETED" && newactiveattemptuid !== "") {
      ...
      await db.collection('StudentAssessments').doc(newData.stdasmt_uid).set(
        {
          stdasmt_attempts: {
...
exports.createStudentAssessmentAttempt = functions.https.onCall(
  async (requestData, context) => {
    ...
    var data = {
      ...
      stdasmt_generalinstructions: asmtDetails["asmt_generalinstructions"] || "",
    ...
    await db.collection('StudentAssessments').doc(stdasmt_uid).set(data, { merge: true });
