    ...
    changeimageButton.addEventListener('click', function (e) {
      ...
      input.onchange = _ => {
        ...
        oFReader.onload = function (oFREvent) {
          ...
          // if (newoption["uid"].length > 0) {
          //   document.getElementById(`img-${newoption["uid"]}`).src = oFREvent.target.result;
          //   $(`#a-img-${newoption["uid"]}`).attr("href", oFREvent.target.result)
